...
ALTER TABLE [dbo].[PTags] DROP CONSTRAINT [FK_dbo.PTags_Personalities_ID1];
ALTER TABLE [dbo].[PTags] DROP CONSTRAINT [FK_dbo.PTags_Personalities_ID2];
ALTER TABLE [dbo].[PTags] DROP CONSTRAINT [FK_dbo.PTags_Personalities_ID3];
